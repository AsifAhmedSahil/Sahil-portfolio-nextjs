    ...
    <>
      ...
      <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-black z-10 p-2'>
          ...
          <h3>React JS / Tailwind / Firebase / JavaScript / Express JS </h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
          ...
          <a href="https://netflix-buldfinal.vercel.app/"><button className='px-8 py-2 mt-4 mr-8'>Demo</button></a>
          <a href="https://github.com/AsifAhmedSahil/Netflix-2.0-react"><button className='px-8 py-2 mt-4'>Code</button></a>
        </div>
