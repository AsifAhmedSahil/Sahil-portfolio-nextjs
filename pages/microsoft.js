...
import netflixImg from "../public/assets/projects/microsoft.png";

import { RiRadioButtonFill } from "react-icons/ri";
import Link from "next/link";
import ProjectsItems from "../components/ProjectsItems";
import MicrosoftDetails from "./MicrosoftDetails";
import MicrosoftDetails2 from "./MicrosoftDetails2";
import MicrosoftDetails3 from "./MicrosoftDetails3";
      ...
      <div className="w-full">
        <div className="w-screen h-[30vh] lg:h-[40vh] relative">
          ...
          <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-black z-10 p-2">
            <h2 className="py-2">Microsoft Clone - Front End</h2>
            <h3>Next JS / Tailwind / Firebase / JavaScript </h3>
          </div>
        </div>
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p>
              ...
              API. User authentication is available so you can signup & signin
            ...
            <a href="https://microsoft-clone-tailwind-react.vercel.app/">
              <button className="px-8 py-2 mt-4 mr-8">Demo</button>
            </a>
            <a href="https://github.com/AsifAhmedSahil/microsoft-clone-tailwind-react">
