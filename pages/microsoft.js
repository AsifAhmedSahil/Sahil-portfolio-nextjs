    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
          ...
          <a href="https://microsoft-clone-tailwind-react.vercel.app/"><button className='px-8 py-2 mt-4 mr-8'>Demo</button></a>
          <a href="https://github.com/AsifAhmedSahil/microsoft-clone-tailwind-react"><button className='px-8 py-2 mt-4 mr-8'>client</button></a>
